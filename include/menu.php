    ...
    <div class="nav-wrapper">
        ...
        <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['institusi'])){
                                ...
                                echo '<h5 class="ins">PEMERINTAH PROVINSI SULAWESI SELATAN</h5>';
                            }

                            if(!empty($data['nama'])){
                                echo '<h5 class="nayas">'.$data['nama'].'</h5>';
                            } else {
                                echo '<h5 class="nayas">DINAS PENDIDIKAN</h5>';
                            }
                            ...
                            if(!empty($data['alamat'])){
                                ...
                                echo '<p class="almt">Jl. Perintis Kemerdekaan KM.10 Tamalanrea Telepon 586083, Fax 585257</p>';
                            }

                            if(!empty($data['status'])){
                                echo '<h5 class="status">'.$data['status'].'</h5>';
                            } else {
                                echo '<h5 class="status">MAKASSAR 90245</h5>';
                            }
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li>
                        <a class="collapsible-header"><i class="material-icons">assignment</i> VALIDASI</a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="?page=val">Surat Masuk</a></li>
                                <li><a href="?page=valsk">Surat Keluar</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-38">email</i> Aplikasi Manajemen Surat </a></li>
            <li><div class="grs"></></li>
            ...
            <li><a class="dropdown-button" href="#!" data-activates="agenda">Validasi Surat <i class="material-icons md-18">arrow_drop_down</i></a></li>
