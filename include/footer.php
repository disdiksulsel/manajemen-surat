...
<footer class="page-footer">
    ...
    <div class="footer-copyright blue accent-2 white-text">
        <div class="container blue accent-2" id="footer">
            <?php
                $query = mysqli_query($config, "SELECT * FROM tbl_instansi");
                while($data = mysqli_fetch_array($query)){
            ?>
                <span class="white-text copyright">&copy; Dinas Pendidikan Provinsi Sulawesi Selatan <?php echo date("Y");?></span>
